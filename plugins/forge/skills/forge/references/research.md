...
| **Drizzle + PGlite** | Current `drizzle-orm` connect API for PGlite **and** node-postgres; `drizzle-kit` config API. | The connect/config API has changed across minors; confirm the dual-driver pattern still holds. |
