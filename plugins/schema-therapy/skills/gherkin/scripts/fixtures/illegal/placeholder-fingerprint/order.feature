# fingerprints:
#   02-glossary.md@sha256:xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
Feature: Order
  ...
  @terminal:order
  Scenario: A delivered order admits no further event
    Given the order is delivered
    When the Order Paid event occurs again
    Then the order remains delivered
