...
| Canonical term | Forbidden term | Reason |
|----------------|----------------|--------|
| Customer | Buyer | One name per patron concept; Buyer is a rejected alternative. |
| Ticket | Seat | A held seat is a Ticket in this context. |
