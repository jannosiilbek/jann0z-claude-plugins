...
Note: this pipeline fixes the term **aggregate** for the lifecycle/section name; in current EventStorming the corresponding sticky is the **Constraint** (legacy "Aggregate").
