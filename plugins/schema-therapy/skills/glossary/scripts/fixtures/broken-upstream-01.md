...
Note: this pipeline fixes the term **aggregate** for the lifecycle/section name. The Order skeleton references `Order Expired`, but that event is MISSING from the Domain Events table above — a self-inconsistent (broken) upstream.
