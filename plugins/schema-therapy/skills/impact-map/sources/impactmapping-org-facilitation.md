...
> Source: impactmapping.org — "Facilitating impact mapping" (https://www.impactmapping.org/facilitation.html)
> License: Creative Commons Attribution 4.0 International. Copyright Neuri Consulting LLP / Gojko Adzic.
> Captured verbatim 2026-06-04 from the canonical source markdown (impactmapping/www.impactmapping.org, facilitation.md).
> Sub-title: Using impact maps for setting product vision, focusing delivery or reframing problems.
