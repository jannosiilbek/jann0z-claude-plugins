...
> Source: impactmapping.org — "Drawing impact maps" (https://www.impactmapping.org/drawing.html)
> License: Creative Commons Attribution 4.0 International. Copyright Neuri Consulting LLP / Gojko Adzic.
> Captured verbatim 2026-06-04 from the canonical source markdown (impactmapping/www.impactmapping.org, drawing.md).
...
(Template diagram: `/assets/im_template.png` on the source site.)
