...
- **04** (`.dbml` + `.md`): `04-transitions.md` carries the `### <TableName>` transition
  ...
  `<Name>Status` enum + the table set (parse-validity gate only — entity enumeration
  and gate state counts come from `04-transitions.md` + `02-glossary.md`). **04 is
  authority for the transition rows; 05 supersedes the table in-document and 04 is
  NEVER edited.**
