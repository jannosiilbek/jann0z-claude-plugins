...
| Audit Opened | Audit System | Order Placed | | — |
| Audit Closed | Audit System | Audit Opened | | — |
...
| Billing System | system | Issues invoices |
| Audit System | automated-process | Records an audit trail |
