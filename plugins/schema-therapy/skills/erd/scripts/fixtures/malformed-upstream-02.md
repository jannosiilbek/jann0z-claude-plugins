...
| Order Placed | The fact that a patron submitted an order. | yes | Order Placed |
| Order Paid | The fact that an order's payment was confirmed. | yes | Order Paid |
| Order Expired | The fact that an unpaid order lapsed. | yes | Order Expired |
| Ticket Reserved | The fact that a seat was held for an order. | yes | Ticket Reserved |
| Ticket Sold | The fact that a held seat was sold. | yes | Ticket Sold |
| Ticket Released | The fact that a held seat was released. | yes | Ticket Released |
