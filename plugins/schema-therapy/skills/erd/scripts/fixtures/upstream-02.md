...
| SeatNumber | The physical seat a ticket allocates. | no | Seat Number Defined |
...
| reservation | Ticket | A held seat is a Ticket in this context; Reservation is a rejected alternative. |
| seat | SeatNumber | The allocated place is the SeatNumber value concept; bare Seat is a rejected abbreviation. |
