...
| INV-Order-2 | Lifecycle: Order Placed Order Paid Order Expired must hold. | within-boundary |
...
|--------|--------------|------------------|------|---------------|
| POL-1 | Order Paid | Ticket | eventual | Selling the allocation happens outside the paying user's transaction. |
