...
|--------|--------------|------------------|------|---------------|
| POL-1 | Order Shipped | Ticket | eventual | Selling the allocation happens outside the paying user's transaction. |
| POL-2 | Order Paid | Ticket | transactional | for convenience |
